...
#define DESISION_STRAIGHT			0
#define DESISION_END_MARK			1
#define DESISION_CURVE_R			2
#define DESISION_CURVE_L			3
...
#define T_DRIVE_DATA_INIT			{ CUSTOM_FALSE, DESISION_STRAIGHT, INSTRUCT_NORMAL, CUSTOM_FALSE, 0 }
